...
public class GetOption {
    ...
    public static DisplayImageOptions getOption() {
        if (options == null) {
            options = new DisplayImageOptions.Builder().cacheOnDisk(true).cacheInMemory(true).considerExifParams(true)
    ...
    public static DisplayImageOptions getFullOption(int dimen) {
        if (getFullOption == null || current_dimen != dimen) {
            current_dimen = dimen;
            getFullOption = new DisplayImageOptions.Builder().cacheOnDisk(true).cacheInMemory(true)
                    .displayer(new RoundedBitmapDisplayer(dimen)).considerExifParams(true)
